...
--Next you will launch the PopulateAlwaysEncrypted.sln Visual Studio Project from the Solutions Folder
--After that, launch a new connection SQL Server with the Column Encryption = Enabled as shown in the white paperp