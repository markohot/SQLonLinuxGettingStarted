...
--These are dependant on Ola Hallengren's Maintenance Solution which is available at 
--https://github.com/olahallengren/sql-server-maintenance-solution
--You can install using the packages by running the 
--https://github.com/olahallengren/sql-server-maintenance-solution/blob/master/MaintenanceSolution.sql file
--Schedules Jobs
--This section is block commented out, becuase it will fail if you don't have Ola's scripts installed
